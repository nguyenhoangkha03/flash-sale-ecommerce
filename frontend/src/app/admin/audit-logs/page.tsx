...
export default function AdminAuditLogsPage() {
  ...
  const fetchLogs = useCallback(async () => {
    try {
      ...
      const uniqueUserIds = new Set(response.data.map((log: AuditLog) => log.user_id));
  ...
  const actionColors: Record<string, string> = {
    RESERVATION_CREATED: "bg-green-500/10 text-green-400 border-green-500/20",
    ...
    PRODUCT_UPDATED: "bg-orange-500/10 text-orange-400 border-orange-500/20",
        ...
        <div className="px-8 py-6 flex flex-col gap-6 max-w-[1400px] mx-auto">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 py-2">
            ...
            >
              ...
              <option value="RESERVATION_EXPIRED">Giữ hàng hết hạn</option>
              ...
              <option value="STOCK_CHANGED">Thay đổi tồn kho</option>
            </select>
          </div>
          ...
          <div className="space-y-3">
            {isLoading ? (
              <div className="flex items-center justify-center py-12">
                ...
                <p className="ml-4 text-text-secondary">Đang tải...</p>
              </div>
            ) : logs.length === 0 ? (
